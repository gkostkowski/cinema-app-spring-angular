...
//                new MovieTest(1000L, "The Matrix", "Lilly Wachowski, Lana Wachowski",
...
//                        1999, MovieGenreBO.ACTION),
//                new MovieTest(1001L, "The Lord of the Rings: The Two Towers", "Peter Jackson",
...
//        List<ScreeningRoomBO> rooms = getScreeningRooms();
//        List<MovieTest> movies = getMovies();
//        return Arrays.asList(  // TODO add hour minutes
//                new ScreeningBO(2001L, LocalDateTime.parse("2019-05-12 17:00",dtFormatter),
//                        movies.get(0), rooms.get(0)),
//                new ScreeningBO(2002L, LocalDateTime.parse("2019-05-12 19:15",dtFormatter),
//                        movies.get(0), rooms.get(1)),
//                new ScreeningBO(2003L, LocalDateTime.parse("2019-05-13 17:30",dtFormatter),
//                        movies.get(1), rooms.get(0)),
//                new ScreeningBO(2004L, LocalDateTime.parse("2019-05-13 17:30",dtFormatter),
//                        movies.get(2), rooms.get(1)),
//                new ScreeningBO(2005L, LocalDateTime.parse("2019-05-14 15:00",dtFormatter),
//                        movies.get(0), rooms.get(0)));
//    }
//
//    @Override
...
//    }
//
//    private List<ScreeningRoomBO> getScreeningRooms() {
//        return Arrays.asList(
//                new ScreeningRoomBO(3001L, 10, 12),
//                new ScreeningRoomBO(3002L, 19, 10)
//        );
//    }
